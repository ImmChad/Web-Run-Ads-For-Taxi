...
@section('contentAdmin')
    ...
    <div class="section-update-taxi">
        ...
        <div class="card-title" style="display: flex;justify-content: space-between">
            ...
            <div class="col-sm-5">
                <div data-value = "{{$dataCar->id}}"class="btn-update-taxi ">
                    UPDATE
                </div>
            </div>
        </div>
                ...
                <div class="section-info-base">
                        <div class="part-input">
                            ...
                            <div class="form-ipt-field form-ipt-text">
                                <input id="ipt_vehicle_number" class="ipt-update-field ipt-url-img" value="{{$dataCar->vehicle_num}}" type="text">
                            </div>
                        </div>
                        <div class="part-input">
                            <div class="label-ipt-field label-ipt-media">
                            ...
                            <div class="form-ipt-field form-ipt-select">
                                <div class="ipt-update-field select-field">
                                    <div id="ipt_group_id" class="value-select-field" data-value="{{$dataCar->company_id}}">
                        ...
                        <div class="form-ipt-field form-ipt-text">
                            <input id="ipt_tablet_id" class="ipt-update-field ipt-url-img" value="{{$dataCar->tablet_id}}"type="text">
                        </div>
                        </div>
                        <div class="part-input">
                        <div class="label-ipt-field label-ipt-media">
                        ...
                        <div class="form-ipt-field form-ipt-text">
                            <input id="ipt_number_phone" class="ipt-update-field ipt-url-img" value="{{$dataCar->sim_number}}"type="text">
                        </div>
                        </div>
                        <div class="part-input">
                        <div class="label-ipt-field label-ipt-media">
                        ...
                        <div class="form-ipt-field form-ipt-text">
                            <input id="ipt_app_id" class="ipt-update-field ipt-url-img" value="{{$dataCar->app_id}}"type="text">
                        </div>
                    </div>
                </div>
