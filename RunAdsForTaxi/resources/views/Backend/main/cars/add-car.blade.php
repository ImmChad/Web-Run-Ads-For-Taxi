...
@section('contentAdmin')
    ...
    <div class="section-add-taxi">
        {{-- <div class="row header-add-taxi">
        ...
        <div class="card-title" style="display: flex;justify-content: space-between">
            ...
            <div class="col-sm-5">
                <div data-value = ""class="btn-add-taxi ">
                    ADD TAXI
                </div>
            </div>
        </div>
        <div class="body-add-taxi ">
            <div class="form-add-taxi">
