...
@section('contentAdmin')
                        ...
                        <form>
                            <div class="form-group row">
                                ...
                                <div class="form-group col-md-7">
                                    <input type="text" class="form-control input-lifeSound" id="name_ud" placeholder="Enter Name Driver ..." value="{{  $dataDriver->name_ud  }}">
                                    <input type="text" id="id_ud" value="{{ $dataDriver->id_ud }}" style="display: none;">
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="form-group col-md-5">
                                ...
                                <div class="form-group col-md-7">
                                    <input type="text" class="form-control input-lifeSound" id="num_phone_ud" placeholder="Enter Telephone Of Drivers ..." value="{{  $dataDriver->num_phone_ud  }}">
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="form-group col-md-5">
                                ...
                                <div class="form-group col-md-7">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" id="birthday_ud" class="form-control input-lifeSound" placeholder="Enter birth day driver ... " aria-label="Username" aria-describedby="basic-addon1" value="{{  $dataDriver->birthday_ud  }}" >
                            ...
                            <div class="form-group" style="text-align: center;">
                                <button type="button" class="btn btn-outline-danger btn_update_driver"><i class="fa fa-share-square-o" aria-hidden="true" style="margin-right: 0.5rem;"></i>Update Driver</button>
                            </div>
    
                        </form>
                    </div>
                    <div class="col">
                        <img src="{{ URL::to($dataDriver->url_avt_ud)}}" class="rounded mx-auto d-block displayImageDriver" alt="" style="width: 200px; height: 200px; object-fit: cover;">
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        $('.btn_update_driver').click(function() {
            ...
            if(name_ud == '' || num_phone_ud == '' || birthday_ud == '') {
                ...
                $.ajax({
                    url: '{{URL::to("/driver/update-new-driver")}}',
                    method: 'post',
                    data: form,
                    contentType: false,
                    processData: false,
                    ...
                    success: function(data) {
                        console.log(data);
                        window.location.href = '{{URL::to("driver/all-driver")}}';
                    },
                    error: function() {
